...
export default function WhyChooseUs() {
  return (
    <section id="why" className="py-24 px-5 md:px-12 bg-dark border-y border-slate-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {whyChooseUs.map((item, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-dark2 border border-slate-200 rounded-none p-8 hover:border-brand transition-all duration-300 transform hover:-translate-y-1 group"
              >
                ...
                <h3 className="font-display font-black text-lg uppercase tracking-tight text-slate-800 mb-2.5 group-hover:text-brand transition-colors duration-200">
                  {item.title}
                </h3>
